...
export const POSTS: BlogPost[] = [
  {
    ...
    featured: true,
    excerpt:
      "Trăng tròn tháng 6 mang đến luồng năng lượng chuyển hoá mạnh mẽ — thời điểm vàng để buông bỏ và đón nhận.",
    content:
  ...
  },
  {
    ...
    emoji: "🃏",
    excerpt:
      "Một trải bài 3 lá đơn giản giúp bạn nhìn rõ quá khứ - hiện tại - tương lai của tuần này.",
    content:
  ...
  },
  {
    ...
    emoji: "🧘",
    excerpt:
      "7 luân xa — 7 cánh cửa năng lượng. Hướng dẫn thiền 15 phút giúp cân bằng cơ thể vi tế.",
    content:
  ...
  },
  {
    ...
    emoji: "✨",
    excerpt:
      "Con số đường đời tiết lộ bài học và sứ mệnh bạn mang theo trong kiếp này.",
    content:
  ...
  },
  {
    ...
    emoji: "☿",
    excerpt:
      "Mỗi năm 3-4 lần, Sao Thủy nghịch hành khiến giao tiếp - công nghệ - di chuyển trục trặc. Đây là cách vượt qua.",
    content:
