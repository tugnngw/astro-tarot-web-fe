...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ASTROTAROT — Khám phá vận mệnh" },
      { name: "description", content: "Trải bài Tarot AI cá nhân hoá & đặt lịch với Reader chuyên nghiệp." },
      { property: "og:title", content: "ASTROTAROT — Khám phá vận mệnh" },
      { property: "og:description", content: "Trải bài Tarot AI cá nhân hoá & đặt lịch với Reader chuyên nghiệp." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ASTROTAROT — Khám phá vận mệnh" },
      { name: "twitter:description", content: "Trải bài Tarot AI cá nhân hoá & đặt lịch với Reader chuyên nghiệp." },
    ],
    links: [
