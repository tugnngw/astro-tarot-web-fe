...
export const Route = createFileRoute("/blog/$slug")({
  ...
  notFoundComponent: () => (
    <div className="min-h-screen grid place-items-center text-center px-4">
      <div>
        <h1 className="font-display text-5xl text-gradient-gold">
          Không tìm thấy
        </h1>
        ...
        <Link
          to="/"
          className="mt-6 inline-block rounded-full bg-gold px-6 py-2.5 text-sm font-medium text-primary-foreground glow-gold"
        >
          Về trang chủ
        </Link>
      </div>
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <article className="mx-auto max-w-3xl px-6 py-10">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-sm text-gold transition hover:text-gold-soft"
        >
        ...
        >
          ...
          >
            <div className="absolute inset-0 grid place-items-center text-[10rem] opacity-30">
              {post.emoji}
            </div>
          </div>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            {related.map((p) => (
              ...
              >
                ...
                >
                  <div className="absolute inset-0 grid place-items-center text-5xl opacity-50">
                    {p.emoji}
                  </div>
                </div>
                <div className="p-3">
                  <div className="line-clamp-2 text-sm font-medium text-foreground transition group-hover:text-gold">
                    {p.title}
                  </div>
        ...
        <div className="mt-10 text-center">
          <Link
            to="/"
            className="inline-flex items-center gap-2 rounded-full border border-gold/50 px-6 py-2.5 text-sm text-gold transition hover:bg-gold/10"
          >
