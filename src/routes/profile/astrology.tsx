    ...
    <div className="relative min-h-screen">
      ...
      <div className="mx-auto max-w-4xl px-6 py-10">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Quản lý hồ sơ chiêm tinh của bạn
        </p>
        ...
        {loading ? (
          ...
          <div className="mt-8 glass rounded-2xl p-8 text-center">
            <p className="text-muted-foreground">
              Chưa có thông tin chiêm tinh
            </p>
            <p className="text-sm text-muted-foreground/60">
              Hãy rút bài Tarot để tạo hồ sơ
            </p>
          </div>
        ) : (
                  ...
                  <div>
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-1 text-sm text-muted-foreground">
                      <p>
                        ...
                        {profile.targetName || "N/A"}
                      </p>
                      <p>
                        <span className="text-foreground">Ngày sinh:</span>{" "}
                        {profile.birthDate}
                      </p>
                      <p>
                        <span className="text-foreground">Giờ sinh:</span>{" "}
                        {profile.birthTime || "N/A"}
                      </p>
                      <p>
                        <span className="text-foreground">Nơi sinh:</span>{" "}
                        {profile.birthPlace}
                      </p>
                      <p>
                        <span className="text-foreground">Loại:</span>{" "}
                        {profile.profileType}
                      </p>
                    </div>
                  </div>
