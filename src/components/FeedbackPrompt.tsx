  ...
  return (
    <>
      <button
        ...
        /* Vị trí do <GocNoi> quyết định — xem chú thích ở đó. Tự khai
           `fixed bottom-… right-…` ở đây là quay lại đúng chỗ chồng nút. */
        className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-card/90 px-3 py-2 text-xs text-gold shadow-lg backdrop-blur transition hover:bg-gold/10"
