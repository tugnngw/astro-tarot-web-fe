  ...
  return (
    ...
    >
      <div
        ...
        className="glass relative w-full max-w-lg rounded-2xl p-8 animate-in zoom-in-95"
      >
        <button
          onClick={onClose}
          aria-label="Đóng"
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Chia sẻ trí tuệ — kết nối với hàng ngàn người tìm kiếm ánh sáng.
        </p>
        <form onSubmit={submit} className="mt-6 grid gap-3">
          ...
          <input
            required
            placeholder="Chuyên môn (Tarot, Chiêm tinh, Numerology…)"
            value={f.expertise}
          ...
          <button
            disabled={loading}
            className="rounded-full bg-gold py-3 font-medium text-primary-foreground glow-gold transition hover:scale-[1.02] disabled:opacity-60"
          >
